...
with SSHTunnelForwarder(ssh_address_or_host=("138.68.141.107", 22), ssh_password="django-m0ses", ssh_username="root",
    ...
    with open('/home/michael/Documents/ChicagoCrimeData_sample.csv') as csvfile:
        ...
        for row in reader:
            # This will iterate through each row in the file, refer to as dictionary with the headers as keys
            # ID,Case Number,Date,Block,IUCR,Primary Type,Description,Location Description,Arrest,Domestic,Beat,
            # District, Ward,Community Area,FBI Code,X Coordinate,Y Coordinate,Year,Updated On,Latitude,Longitude,
            # Location
